...
const char *argp_program_version = "cpuaw 0.1";
const char *argp_program_bug_address = "<bpf@vger.kernel.org>";
const char argp_program_doc[] =
"Summarize run queue (scheduler) latency as a histogram.\n"
"\n"
"USAGE: cpuaw [--help] [-T] [-m] [--pidnss] [-L] [-P] [-p PID] [interval] [count]\n"
"\n"
"EXAMPLES:\n"
"    cpuaw         # summarize run queue latency as a histogram\n"
"    cpuaw 1 10    # print 1 second summaries, 10 times\n"
"    cpuaw -mT 1   # 1s summaries, milliseconds, and timestamps\n"
"    cpuaw -P      # show each PID separately\n"
"    cpuaw -p 185  # trace PID 185 only\n";
